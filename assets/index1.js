...
const getWriterList = () => {
  let writerList = [];
  writerList.push(HanziWriter.create(screentWidthFlag ? 'phone_sheng' : 'sheng', '嫁', WRITER_CONFIG));
  writerList.push(HanziWriter.create(screentWidthFlag ? 'phone_ri' : 'ri', '给', WRITER_CONFIG));
  writerList.push(HanziWriter.create(screentWidthFlag ? 'phone_kuai' : 'kuai', '我', WRITER_CONFIG));
  writerList.push(HanziWriter.create(screentWidthFlag ? 'phone_le' : 'le', '吧', WRITER_CONFIG));
